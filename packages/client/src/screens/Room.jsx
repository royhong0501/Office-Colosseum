...
// 房間內頁：玩家進入某 Room 後的單房 lobby（角色挑選、ready、加 bot、開戰）。
// 之前叫 Lobby，因應多房改造改名 Room；多房列表頁變成 Lobby。
export default function Room({ gameType, config, onMatchStart, onBack, gameName }) {
