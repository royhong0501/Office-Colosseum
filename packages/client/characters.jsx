// Character data for HiiiColosseum
// 10 Cat breeds + 10 Dog breeds with ASCII art and stats
...
const DOG_BREEDS = [
  ...
  },
  {
    ...
    stats: { hp: 55, atk: 40, def: 25, spd: 95, spc: 95 },
    skill: '狂暴尖叫',
    skillDesc: '小身體爆發巨大能量',
    color: '#DEB887',
  },
...
const ALL_CHARACTERS = [...CAT_BREEDS, ...DOG_BREEDS];

window.CAT_BREEDS = CAT_BREEDS;
window.DOG_BREEDS = DOG_BREEDS;
